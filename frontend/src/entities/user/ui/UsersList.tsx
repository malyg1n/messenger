...
export default function UsersList({
  ...
  // formatChatTime форматирует timestamp последнего сообщения для sidebar.
  ...
  // toTimeMs нужен для безопасной сортировки чатов по времени.
  ...
  // Загружаем чаты и пользователей при инициализации и по refreshToken.
  useEffect(() => {
    let isActive = true
